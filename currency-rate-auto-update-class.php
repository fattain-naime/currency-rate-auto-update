...
$plugin_meta = [
    ...
    'Description' => 'Automatically updates currency conversion rates daily using ExchangeRate-API. Base currency = PipraPay default currency.',
    'Version' => '1.0.0',
    ...
    'Plugin URI' => 'https://github.com/fattain-naime/Currency-Rate-Auto-Update-for-PipraPay',
    'Text Domain' => '',
    'Domain Path' => '',
    'Requires PHP' => '7.4'
];
